...
import { dashboardReport, pendingLeads, whatsappReport, leadbotReport,emailReport } from "../../../apis";
...
const ChildReport = () => {
    ...
    const [filter, setFilter] = useState({
        parent_user_uid: selectedUser.user_uid,
        include_yesterday: 0,
        include_last_week: 0,
    ...
    useEffect(() => {
        ...
        if (activeTab === "email_report") fetchWhatsappReportAnalytics(filter);
