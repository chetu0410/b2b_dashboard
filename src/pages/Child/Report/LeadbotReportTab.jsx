...
const LeadbotReportTab = ({ fetching, data }) => {
    const index = data.findIndex((obj) => "self_account_email" in obj);

    return (
        <section>
            <div className="content mb-5">
                {/*<div className="block text-lg font-bold my-4">Child Account Leadbot Report:</div>*/}
                <div className="flex items-center justify-between px-4 py-4 rounded-md shadow-app1 mb-6">
                    <div className="flex items-center">
                        <span className="w-12 h-12 f-center border border-green-500 rounded-full">
                            <FaRobot style={{ color: "#09D261", fontSize: "24" }} />
                        </span>
                ...
                {/*data.length > 1 && (
                    <>
                        <div className="block text-lg font-bold my-4">Child Account(s) Leadbot Report(s):</div>
...
export default LeadbotReportTab;
