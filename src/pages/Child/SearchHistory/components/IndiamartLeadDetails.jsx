...
import { allocateCall, callingHistory, editIndiamartLead } from "../../../../apis";
import CallStatus from "./CallStatus";
import formatDate from "../../../../utils/formatDate";

const IndiamartLeadDetails = ({ data = {}, onClose, onEdit }) => {
            ...
            <div className="details p-3 mb-5">
                <div className="grid grid-cols-8 gap-4 mb-5">
                    <p className="col-span-3 font-medium">
                        Mobile Number ({leadData.mobile ? leadData.mobile.split(",").length : 0})
                    </p>
                ...
                <div className="grid grid-cols-8 gap-4 mb-5">
                    <p className="col-span-3 font-medium">Query Product</p>
                ...
                <div className="grid grid-cols-8 gap-4 mb-5">
                    <p className="col-span-3 font-medium">Query Category</p>
                ...
                <div className="grid grid-cols-8 gap-4 mb-5">
                    <p className="col-span-3 font-medium">Query Message:</p>
                ...
                <div className="grid grid-cols-8 gap-4 mb-5">
                    <p className="col-span-3 font-medium">Query Time</p>
