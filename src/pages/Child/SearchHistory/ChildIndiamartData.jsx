    ...
    return (
        <div className="indiamart_data_page page">
            ...
            {leadModelDetails.open && (
                <div className="lead_details fixed top-20 right-0 bottom-0 max-h-lg max-w-lg w-full overflow-y-auto shadow-app1">
...
export default ChildIndiamartData;
