...
const ChildSearch = () => {
    ...
    const [filters, setFilters] = useState({
        ...
        search_query: "",
        child_user_uid: selectedUser.user_uid,
    });
    ...
    const fetchAllLeades = async (data) => {
        ...
        try {
            ...
            if (res?.data?.integrations) {
                localStorage.setItem("child-integrations", JSON.stringify(res.data.integrations));
            }
            ...
            if (res?.data?.facebook_integrations) {
                localStorage.setItem("child_fb_forms", JSON.stringify(res.data.facebook_integrations));
            }
    ...
    useEffect(() => {
        filters.child_user_uid = selectedUser.user_uid;
        fetchAllLeades(filters);
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [selectedUser]);
    ...
    return (
        <div className="search_history_page page">
            ...
            <section className="filters mb-5">
                ...
                <div className="options flex justify-end w-full items-center mt-4 mb-4">
                    {/*<div className="flex items-center gap-4">
                        <p>Options: </p>
