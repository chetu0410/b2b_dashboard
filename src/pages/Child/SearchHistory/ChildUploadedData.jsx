...
import { allocateCall, getUserUploadedCSVData, uploadCSVToDashboard } from "../../../apis";
...
const MyUploadedData = () => {
    ...
    const handleClickToogleLeadDetails = (e, open, data = {}) => {
    ...
    const handleClickDelete = async (e) => {
        try {
            const url = "https://api.procbee.in/dashboard/deleteFromGetB2b";
    ...
    return (
        <div className="serach_history_page page">
            <section className="filters mb-5">
                ...
                <div className="flex flex-wrap items-center gap-2 overflow-auto whitespace-nowrap sm:flex-nowrap">
                    <p className="text-gray-600 text-sm font-medium">
                        Showing {leadData.length} of {page.total}
                    </p>
                ...
                <div className="options flex items-center gap-4 mt-4 mb-4">
                    <p>Options: </p>
                        ...
                        <tbody className="border border-gray-200">
                            {leadData.map((details, i) => (
                                <tr
                                    ...
                                    onClick={(e) => handleClickToogleLeadDetails(e, true, details)}
                                >
            ...
            {leadModelDetails.open && (
                <section className="lead_details fixed top-20 right-0 bottom-full h-full max-w-lg w-full">
                    <LeadDetails
                        key={leadModelDetails.id}
                        data={leadModelDetails}
                        onClose={(e) => handleClickToogleLeadDetails(e, false)}
                    />
                </section>
            )}
