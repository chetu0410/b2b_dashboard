...
import { allocateCall, callingHistory, editTradeIndiaLead, callingUpdate, leadStatusUpdate } from "../../../../apis";
...
const TradeIndiaLeadDetails = ({ data = {}, onClose, onEdit, handleMustFinalise }) => {
    ...
    const [mobileList, setMobileList] = useState(() => {
        return formatTINumbers(leadData.sender_mobile, leadData.sender_other_mobiles)
            ...
            {!isLogging && (
                <div className="details p-3">
                    ...
                    {isEditing && (
                        <>
                            <div className="flex flex-row items-center w-full gap-2 mb-5">
                                <p className="basis-1/3 font-medium">Sender Mobile:</p>
                            ...
                            <div className="flex flex-row items-center w-full gap-2 mb-5">
                                <p className="basis-1/3 font-medium">Other Mobile Numbers</p>
                    ...
                    <div className="flex flex-row items-center w-full gap-2 mb-5">
                        <p className="basis-1/3 font-medium">Inquiry Message:</p>

                        {!isEditing && (
                            <div className="basis-2/3 text-gray-600 whitespace-pre-line break-words">
                                {leadData.message || "-"}
                            </div>
                        )}
                    ...
                    {isEditing && (
                        <>
                            <div className="flex flex-row items-center w-full gap-2 mb-5">
                                <p className="basis-1/3 font-medium">Sender City:</p>
                            ...
                            <div className="flex flex-row items-center w-full gap-2 mb-5">
                                <p className="basis-1/3 font-medium">Sender State:</p>
                            ...
                            <div className="flex flex-row items-center w-full gap-2 mb-5">
                                <p className="basis-1/3 font-medium">Sender Country:</p>
